...
func (s *Service) GetHighestSymService(symbol string) (models.Prices, error) {
...
func (s *Service) GetHighestSymExcService(symbol, exchange string) (models.Prices, error) {
